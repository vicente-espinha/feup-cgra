...
MySubmarine.prototype.display = function() {
    ...
    this.scene.rotate( this.rotateHelice  * this.speedHelices, 0, 0, 1);
...
MySubmarine.prototype.rotateHelices = function() {
   if (this.speed != 0) {
             ...
             this.speedHelices = this.speed;
    }
    else if (this.speed == 0){
        this.rotateHelice = this.rotateHelice + Math.PI/10;
        this.speedHelices = 0.7;
    }
}
;

MySubmarine.prototype.rotateUp = function() {
   if (this.rotX >= -35 && this.speed > 0) {
            this.rotX -= 2* this.speed; 
    }else if(this.speed < 0 && this.rotX <= 35){
         this.rotX -= 2* this.speed;
    }
}
;
